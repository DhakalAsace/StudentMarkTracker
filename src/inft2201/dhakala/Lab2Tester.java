...
public class Lab2Tester {
	...
	public static void main(String[] args) throws SQLException {
		...
		try {
	        ...
	        long myStudentId = 100886468L;
	        try {
	            Student myStudent = Student.retrieve(myStudentId); 
	            if (myStudent != null) {
	                System.out.println("My student record retrieved from the database:");
	                myStudent.dump();
	            } else {
	                System.out.println("No student record found for ID: " + myStudentId);
	            }
	        } catch (NotFoundException e) {
	            System.out.println("Student with ID " + myStudentId + " not found.");
	        }
